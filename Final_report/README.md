...
There are four datasets: Beneficiary, Inpatient, Outpatient and Train. Here is a short description about each dataset blow:
...
The table below lists all the ML models along with their roc auc score, recall, precision and accuracy score:

![](https://github.com/damayantinaik/Health_care_Fraud_Detection_Medicare/blob/main/Final_report/all_ML_models.PNG)
